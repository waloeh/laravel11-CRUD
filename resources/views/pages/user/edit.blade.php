        ...
        <div class="card xl:col-span-2">
            <div class="card-body flex flex-col p-6">
                <header class="flex mb-5 items-center border-b border-slate-100 dark:border-slate-700 pb-5 -mx-6 px-6">
                    <div class="flex-1">
                        <div class="card-title text-slate-900 dark:text-white">Form Edit User</div>
                    </div>
                </header>
                <div class="card-text h-full">
                    <form action="{{ route('user.update', $user) }}" class="space-y-4" id="" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="grid md:grid-cols-2 gap-6">
                            ...
                            <div class="input-area">
                                ...
                                <div class="relative">
                                    <input id="password" type="password" name="password" class="form-control pr-9"
                            ...
                            <div class="flex items-center space-x-2">
                                <label
                                    ...
                                    <input type="checkbox" name="is_active" class="sr-only peer" @checked($user->is_active ?? false)>
                                    <div
